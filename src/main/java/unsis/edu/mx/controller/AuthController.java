...
import unsis.edu.mx.payload.request.LoginRequest;
import unsis.edu.mx.payload.request.SignupRequest;
import unsis.edu.mx.payload.response.MessageResponse;
import unsis.edu.mx.payload.response.UserInfoResponse;
import unsis.edu.mx.security.jwt.JwtUtils;
...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
	  System.out.println("autenteicando...");
